            ...
            data.forEach((product) => {
                ...
                html += `
                    <tr>
                        ...
                        <td>₱ ${product.srp}</td>
                        <td>
                            <button class="product-btn fa fa-edit btn edit-btn" data-id="${product.id}"></button>
                            <button class="product-btn fa fa-trash btn delete-btn" data-id="${product.id}"></button>
                        </td>
                    </tr>
                `
            })
